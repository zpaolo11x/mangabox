<picture><img alt="MangaBox Logo" src="mangabox-logo-name-3.png" height=80px></picture>

MangaBox is a simple Electron client for Komga.

<img alt="MangaBox main UI" src=".localassets/MangaBox_001.png" width=60%>
...
<img alt="MangaBox main UI" src=".localassets/MangaBox_002.png" width=60%>

There's no book view (yet) but a series view with all volumes.

<img alt="MangaBox main UI" src=".localassets/MangaBox_004.png" width=60%>

Reading mode supports two pages and single page, with "paper like" effects

<img alt="MangaBox main UI" src=".localassets/MangaBox_003.png" width=60%>
